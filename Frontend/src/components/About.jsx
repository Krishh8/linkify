    ...
    return (
        <div className='bodyGradient min-h-screen flex-col justify-center items-center'>
            <div className="max-w-3xl p-5 sm:mx-auto">
                <h1 className="text-4xl font-bold mb-6 text-center headingText">About<span className='logoText'> Linkify</span></h1>
                <p className="mb-4 text-lg subHeadingText">
                ...
                <p className="text-lg subHeadingText">
