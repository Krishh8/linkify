        ...
        <div>
            ...
            <div className="relative">
                <input
                    ...
                    onBlur={onBlur}
                    className={`w-full rounded-md bg-white px-3 py-1.5 pr-10 text-base text-gray-900 outline-1 -outline-offset-1 ${error && touched ? "outline-red-400" : "outline-blue-400"
